...
SWIFT_CLASS("_TtC21temp_detail_deal_view11AppDelegate")
...
SWIFT_CLASS("_TtC21temp_detail_deal_view18DealViewController")
@interface DealViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate>
...
@property (nonatomic) IBOutlet UIButton * __null_unspecified newestButton;
@property (nonatomic) IBOutlet UIButton * __null_unspecified oldestButton;
@property (nonatomic, weak) IBOutlet UICollectionView * __null_unspecified cardCollectionView;
...
SWIFT_CLASS("_TtC21temp_detail_deal_view18TempViewController")
...
SWIFT_CLASS("_TtC21temp_detail_deal_view8dealCell")
